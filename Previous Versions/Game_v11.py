...
def game():
    ...
    class Arwing(pygame.sprite.Sprite):
        ...
        def __init__(self, x, y):
            ...
            self.image = pygame.image.load("arwing_body.png").convert()
    ...
    class Left_wing(pygame.sprite.Sprite):
        ...
        def __init__(self, x, y):
            ...
            self.image = pygame.image.load("arwing_leftwing.png").convert()
    ...
    class Right_wing(pygame.sprite.Sprite):
        ...
        def __init__(self, x, y):
            ...
            self.image = pygame.image.load("arwing_rightwing.png").convert()
