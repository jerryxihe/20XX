...
def game(ship_type):
    ...
    class Boss(pygame.sprite.Sprite):
        ...
        def __init__(self, x, y):
            ...
            self.boss_shot = pygame.mixer.Sound("shot.ogg")
    ...
    boss_laser = pygame.mixer.Sound("boss_laser.ogg")
    ...
    while not done:
        ...
        if timer == 95 and wave15 == False:
            ...
            wave15 = True
        if timer == 110 and bosswave == False:
            boss.rect.x = 163
            boss.rect.y = 10
            bosswave = True

        if timer % 5 == 0 and timer > 110 and laser_warning_appear == False:
            ...
            laser_warning_appear = True
            boss_laser.play()

        if timer % 5 == 1 and timer > 110 and laser_fired == False:
            boss.laser()
            laser_fired = True
        ...
        for hit in arwing_boss_laser_hit:
            gameover = True
            gameover_timer = time.clock()
            print(gameover_timer)
        ...
        if gameover == True and gameover_timer > 0.01:
            time.sleep(1)
            lose()
