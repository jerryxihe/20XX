...
def game():
    ...
    def wave(green_alien_number, green_alien_delay, blue_alien_number, blue_alien_delay):
        for i in range(green_alien_number):
            green_alien = Green_alien()
            green_alien.rect.x = random.randrange(screen_width)
            green_alien.rect.y = -green_alien_delay - random.randint(0, 100)
        ...
        for i in range(blue_alien_number):
            ...
            blue_alien.rect.y = -blue_alien_delay - random.randint(0, 100)
    ...
    while not done:
        ...
        score = green_alien_hit * 50 + blue_alien_hit * 100
