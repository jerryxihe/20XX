def select_ship(highscore):
    from math import sin, cos, pi
    from Menu_Function import main_menu
    from Intro_Function import intro
    import pygame
    BLACK = (0,0,0)
    WHITE = (255,255,255)
    displayWidth = 448
    ...
    #Import ship images
    ship1 = pygame.image.load("classic_arwing.png")
    ship1= pygame.transform.scale(ship1,(174,126))
    ship2 = pygame.image.load("space_arwing.png")
    ship2= pygame.transform.scale(ship2,(174,126))
    ship3 = pygame.image.load("steel_arwing.png")
    ship3= pygame.transform.scale(ship3,(174,126))
    ship4 = pygame.image.load("kappapride_arwing.png")
    ship4= pygame.transform.scale(ship4,(174,126))
    ship5 = pygame.image.load("ice_arwing.png")
    ship5= pygame.transform.scale(ship5,(174,126))
    ship6 = pygame.image.load("victorious_arwing.png")
    ship6= pygame.transform.scale(ship6,(174,126))
    ship7 = pygame.image.load("cool_arwing.png")
